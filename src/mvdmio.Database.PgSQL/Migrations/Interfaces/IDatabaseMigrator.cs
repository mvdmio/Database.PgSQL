...
public interface IDatabaseMigrator
{
   ...
   ///    If the database is empty and a schema file path was configured, the schema file
   ///    is applied first, then any remaining migrations after the schema version are run.
   /// </summary>
   ...
   ///    If the database is empty and a schema file path was configured (with a version &lt;= targetIdentifier),
   ///    the schema file is applied first, then any remaining migrations up to the target are run.
   /// </summary>
