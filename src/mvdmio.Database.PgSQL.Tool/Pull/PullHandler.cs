...
internal sealed class PullHandler
{
   ...
   )
   {
      ...
      var header = """
                    ...
                    --
                    -- This schema file was generated by the mvdmio.Database.PgSQL.Tool CLI.
                    -- Any manual changes will be overwritten the next time 'db pull' is executed.
                    --
                    -- To change the database schema, create or modify migration files instead.
                    -- =============================================================================

                    """;

      await _fileSystem.WriteAllTextAsync(outputPath, header + schemaResult.Script, cancellationToken);
