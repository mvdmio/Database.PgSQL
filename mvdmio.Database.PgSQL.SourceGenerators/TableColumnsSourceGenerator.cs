...
{
   private const string TABLE_ATTRIBUTE_NAME = "Table";
   private const string COLUMN_ATTRIBUTE_NAME = "Column";
   private const string DB_TABLE_TYPE_NAME = "DbTable";
      ...
      context.RegisterSourceOutput(
         ...
         static (context, source) => {
            ...
            foreach (var classDeclaration in classDeclarations)
            {
               ...
               var columnNames = GetColumnNames(model, classDeclaration);
   ...
   private static List<string> GetColumnNames(SemanticModel model, ClassDeclarationSyntax classDeclaration)
   {
   ...
   private static string GenerateSource(INamedTypeSymbol classSymbol, List<string> columnNames)
   {
      ...
      return $$"""
         ...
         namespace {{namespaceName}}
         {
             ...
             {
                 internal static readonly string[] ColumnNames { get; } = new[] { {{columnArray}} };
             }
         }
         """;
   }
